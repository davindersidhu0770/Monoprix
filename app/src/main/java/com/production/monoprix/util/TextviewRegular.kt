...
class TextviewRegular(context: Context, attrs: AttributeSet?) : androidx.appcompat.widget.AppCompatTextView(context, attrs) {
...
//        this.typeface = Typeface.createFromAsset(context.assets, "SFProDisplay-Regular.ttf")
        this.typeface =(ResourcesCompat.getFont(context, R.font.poppinsregular))
    }
